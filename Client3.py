...
def windows():
    ...
    #Intro Part
    global profile_name
    profile_name = Label(frame, bg=bgcolor, fg="white", text="[ Anis likhon ]", font=("Helvetica 15 bold"))
...
def LogOut():
    ...
    disconnected = "Anis Disconnected"
