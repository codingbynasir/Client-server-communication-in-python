...
def windows():
    ...
    #Intro Part
    global profile_name
    profile_name = Label(frame, bg=bgcolor, fg="white", text="[ Tanvir Rahman ]", font=("Helvetica 15 bold"))
    profile_name.place(x=170, y=10)

    Online1_name = Label(frame, bg=bgcolor, fg="white", text="Anis Likhon", font=("Helvetica 12 bold"))
    Online1_name.place(x=18, y=50)
    Online2_name = Label(frame, bg=bgcolor, fg="white", text="Nasir Khan", font=("Helvetica 12 bold"))
...
def LogOut():
    ...
    disconnected = "Tanvir Disconnected"
